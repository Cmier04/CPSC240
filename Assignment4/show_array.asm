...
;use counter to ensure size limit is not exceeded
mov     r13, 0
...
;if array is done printing
jmp endloop

notdone:
;output value with IEEE form and decimal form
mov     rax, 2
...
;add to counter and jump back to check array capacity
inc     r13
jmp     array_capacity
