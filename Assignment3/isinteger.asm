...
;  Date development of version 1 began 2024-Oct-09
;  Date development of version 1 completed 2024-Oct-10
;
;Purpose
...
;  Linux: nasm -f elf64 -l isinteger.lis -o isinteger.o isinteger.asm
